...
/**
 * MerchantAPIListOfValuesLOVApi Class Doc Comment
 *
 * @category Class
 * @package  IMN\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchantAPIListOfValuesLOVApi
{
    /**
     * @var ClientInterface
     */
     ...
     * @return \IMN\Swagger\Client\Model\UserListOfValuesResponse
     */
     ...
     * @throws \IMN\Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IMN\Swagger\Client\Model\UserListOfValuesResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserListOfValuesWithHttpInfo($list_name, $accept_language = null, $if_none_match = null)
    {
        $returnType = '\IMN\Swagger\Client\Model\UserListOfValuesResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IMN\Swagger\Client\Model\UserListOfValuesResponse',
    ...
    protected function getUserListOfValuesRequest($list_name, $accept_language = null, $if_none_match = null)
    {
        ...
        $resourcePath = '/merchant/lov/v1/{listName}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \IMN\Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IMN\Swagger\Client\Model\UserLovIndex
     */
     ...
     * @throws \IMN\Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IMN\Swagger\Client\Model\UserLovIndex, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUserLovIndexWithHttpInfo()
    {
        $returnType = '\IMN\Swagger\Client\Model\UserLovIndex';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IMN\Swagger\Client\Model\UserLovIndex',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
