...
/**
 * MerchantOrdersListApi Class Doc Comment
 *
 * @category Class
 * @package  IMN\Swagger\Client
 * @author   Swagger Codegen team
...
class MerchantOrdersListApi
{
     ...
     * @param  \IMN\Swagger\Client\Model\OrderListRequest $request request (required)
     *
     * @throws \IMN\Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \IMN\Swagger\Client\Model\OrderListFull
     */
    public function getOrderListFull($merchant_code, $accept_encoding, $request)
    {
        list($response) = $this->getOrderListFullWithHttpInfo($merchant_code, $accept_encoding, $request);
        return $response;
    }
     ...
     * @param  string $merchant_code The merchant code (required)
     * @param  string $accept_encoding Allows the client to indicate wether it accepts a compressed encoding to reduce traffic size (required)
     * @param  \IMN\Swagger\Client\Model\OrderListRequest $request (required)
     *
     * @throws \IMN\Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \IMN\Swagger\Client\Model\OrderListFull, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrderListFullWithHttpInfo($merchant_code, $accept_encoding, $request)
    {
        $returnType = '\IMN\Swagger\Client\Model\OrderListFull';
        $request = $this->getOrderListFullRequest($merchant_code, $accept_encoding, $request);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\IMN\Swagger\Client\Model\OrderListFull',
     ...
     */
    public function getOrderListFullAsync($merchant_code, $accept_encoding, $request)
    {
        return $this->getOrderListFullAsyncWithHttpInfo($merchant_code, $accept_encoding, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrderListFullAsyncWithHttpInfo($merchant_code, $accept_encoding, $request)
    {
        $returnType = '\IMN\Swagger\Client\Model\OrderListFull';
        $request = $this->getOrderListFullRequest($merchant_code, $accept_encoding, $request);
     ...
     */
    protected function getOrderListFullRequest($merchant_code, $accept_encoding, $request)
    {
        // verify the required parameter 'merchant_code' is set
        if ($merchant_code === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $merchant_code when calling getOrderListFull'
            );
        }
        ...
        $resourcePath = '/merchant/orders/v1/{merchantCode}/list';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
