...
/**
 * DuplicateMerchantMarketplaceOfferOperationException Class Doc Comment
 *
 * @category Class
 * @description Duplicate operation on an offer has been {duplicateCount} times for the marketplace &#39;{marketplaceCode}&#39; and the merchant &#39;{merchantCode}&#39;: - sku: &#39;{sku}&#39;  - gtin: &#39;{gtin}&#39; - itemCondition: &#39;{itemCondition}&#39;  - fulfilledBy: &#39;{fulfilledBy}&#39;
 * @package  IMN\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DuplicateMerchantMarketplaceOfferOperationException implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'duplicateMerchantMarketplaceOfferOperationException';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fulfilled_by'] === null) {
            $invalidProperties[] = "'fulfilled_by' can't be null";
        }
    ...
    public function setDuplicateCount($duplicate_count)
    {
        ...
        if (($duplicate_count < 2)) {
            throw new \InvalidArgumentException('invalid value for $duplicate_count when calling DuplicateMerchantMarketplaceOfferOperationException., must be bigger than or equal to 2.');
        }
