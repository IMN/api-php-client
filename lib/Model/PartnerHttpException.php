...
/**
 * PartnerHttpException Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PartnerHttpException implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'partnerHttpException';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['log_uri'] === null) {
            $invalidProperties[] = "'log_uri' can't be null";
        }
