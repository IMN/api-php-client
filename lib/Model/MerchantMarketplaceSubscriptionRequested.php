...
/**
 * MerchantMarketplaceSubscriptionRequested Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchantMarketplaceSubscriptionRequested extends MerchantEventPushed 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'merchantMarketplaceSubscriptionRequested';
     ...
     * Sets external_id
     *
     * @param string $external_id If the request is coming from an external system we will keep the identifier
     *
     * @return $this
     */
