...
class OrderHistory implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'change_order_reportings' => '\IMN\Swagger\Client\Model\ChangeOrderReporting[]',
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['change_order_reportings'] === null) {
            $invalidProperties[] = "'change_order_reportings' can't be null";
        }
     ...
     *
     * @return \IMN\Swagger\Client\Model\ChangeOrderReporting[]
     */
     ...
     *
     * @param \IMN\Swagger\Client\Model\ChangeOrderReporting[] $change_order_reportings The list of change order operation
     *
     * @return $this
     */
