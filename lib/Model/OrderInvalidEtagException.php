...
/**
 * OrderInvalidEtagException Class Doc Comment
 *
 * @category Class
 * @description The order change cannot be applied because the &#39;{invalidETag}&#39; does not match the expetected one &#39;{expectedETag}&#39;. Please reload your order and send the latest etag to change the order. If the problem persist please contact our support team. MarkeplaceOrderId: &#39;{marketplaceOrderId}&#39; Marketplace: &#39;{marketplaceCode}&#39; Merchant: &#39;{merchantCode}&#39;
 * @package  IMN\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderInvalidEtagException implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'orderInvalidEtagException';
    ...
    protected static $swaggerTypes = [
        ...
        'invalid_e_tag' => '\IMN\Swagger\Client\Model\OrderEtag',
        'expected_e_tag' => '\IMN\Swagger\Client\Model\OrderEtag'
    ];
    ...
    protected static $attributeMap = [
        ...
        'invalid_e_tag' => 'invalidETag',
        'expected_e_tag' => 'expectedETag'
    ];
    ...
    protected static $setters = [
        ...
        'invalid_e_tag' => 'setInvalidETag',
        'expected_e_tag' => 'setExpectedETag'
    ];
    ...
    protected static $getters = [
        ...
        'invalid_e_tag' => 'getInvalidETag',
        'expected_e_tag' => 'getExpectedETag'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['invalid_e_tag'] = isset($data['invalid_e_tag']) ? $data['invalid_e_tag'] : null;
        $this->container['expected_e_tag'] = isset($data['expected_e_tag']) ? $data['expected_e_tag'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['invalid_e_tag'] === null) {
            $invalidProperties[] = "'invalid_e_tag' can't be null";
        }
        if ($this->container['expected_e_tag'] === null) {
            $invalidProperties[] = "'expected_e_tag' can't be null";
        }
     ...
     * Gets invalid_e_tag
     *
     * @return \IMN\Swagger\Client\Model\OrderEtag
     */
    public function getInvalidETag()
    {
        return $this->container['invalid_e_tag'];
    }

    /**
     * Sets invalid_e_tag
     *
     * @param \IMN\Swagger\Client\Model\OrderEtag $invalid_e_tag invalid_e_tag
     *
     * @return $this
     */
    public function setInvalidETag($invalid_e_tag)
    {
        $this->container['invalid_e_tag'] = $invalid_e_tag;
     ...
     * @return \IMN\Swagger\Client\Model\OrderEtag
     */
    public function getExpectedETag()
    {
        return $this->container['expected_e_tag'];
    }

    /**
     * Sets expected_e_tag
     *
     * @param \IMN\Swagger\Client\Model\OrderEtag $expected_e_tag expected_e_tag
     *
     * @return $this
     */
    public function setExpectedETag($expected_e_tag)
    {
        $this->container['expected_e_tag'] = $expected_e_tag;
