...
/**
 * MarketplaceShippingChargeRuleType Class Doc Comment
 *
 * @category Class
 * @package  IMN\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MarketplaceShippingChargeRuleType
{
    /**
     * Possible values of this enum
     */
    const PERCENT_INCREASE = 'PercentIncrease';
    const PERCENT_DECREASE = 'PercentDecrease';
    const AMOUNT_INCREASE = 'AmountIncrease';
    const AMOUNT_DECREASE = 'AmountDecrease';
    const SAME = 'Same';
    const FIXED = 'Fixed';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::PERCENT_DECREASE,
            self::AMOUNT_INCREASE,
            self::AMOUNT_DECREASE,
            self::SAME,
            self::FIXED,
        ];
    }
