...
/**
 * OrderChangeAlreadyInProgressException Class Doc Comment
 *
 * @category Class
 * @description There is an order change currently is progress for the &#39;{marketplaceOrderId}&#39; for the marketplace &#39;{marketplaceCode}&#39; and the merchant &#39;{merchantCode}&#39;. | Current CorrelationId: &#39;{currentCorrelationId}&#39;
 * @package  IMN\Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderChangeAlreadyInProgressException implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'orderChangeAlreadyInProgressException';
    ...
    protected static $swaggerTypes = [
        ...
        'current_correlation_id' => '\IMN\Swagger\Client\Model\CorrelationId'
    ];
    ...
    protected static $setters = [
        ...
        'current_correlation_id' => 'setCurrentCorrelationId'
    ];
    ...
    protected static $getters = [
        ...
        'current_correlation_id' => 'getCurrentCorrelationId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['current_correlation_id'] = isset($data['current_correlation_id']) ? $data['current_correlation_id'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['current_correlation_id'] === null) {
            $invalidProperties[] = "'current_correlation_id' can't be null";
        }
    ...
    /**
     * Gets current_correlation_id
     *
     * @return \IMN\Swagger\Client\Model\CorrelationId
     */
    public function getCurrentCorrelationId()
    {
        return $this->container['current_correlation_id'];
    }

    /**
     * Sets current_correlation_id
     *
     * @param \IMN\Swagger\Client\Model\CorrelationId $current_correlation_id current_correlation_id
     *
     * @return $this
     */
    public function setCurrentCorrelationId($current_correlation_id)
    {
        $this->container['current_correlation_id'] = $current_correlation_id;
