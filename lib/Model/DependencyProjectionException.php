...
/**
 * DependencyProjectionException Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DependencyProjectionException implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'dependencyProjectionException';
    ...
    protected static $swaggerTypes = [
        ...
        'projection_message_id' => '\IMN\Swagger\Client\Model\MessageId',
        'current_message_id' => '\IMN\Swagger\Client\Model\MessageId'
    ];
    ...
    protected static $setters = [
        ...
        'projection_type' => 'setProjectionType',
        'projection_message_id' => 'setProjectionMessageId',
        'current_message_id' => 'setCurrentMessageId'
    ];
    ...
    protected static $getters = [
        ...
        'projection_message_id' => 'getProjectionMessageId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['projection_type'] = isset($data['projection_type']) ? $data['projection_type'] : null;
        $this->container['projection_message_id'] = isset($data['projection_message_id']) ? $data['projection_message_id'] : null;
        $this->container['current_message_id'] = isset($data['current_message_id']) ? $data['current_message_id'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['projection_type'] === null) {
            $invalidProperties[] = "'projection_type' can't be null";
        }
        if ($this->container['projection_message_id'] === null) {
            $invalidProperties[] = "'projection_message_id' can't be null";
        }
        if ($this->container['current_message_id'] === null) {
            $invalidProperties[] = "'current_message_id' can't be null";
        }
    ...
    /**
     * Gets projection_type
     *
     * @return string
     */
    public function getProjectionType()
    {
        return $this->container['projection_type'];
    }

    /**
     * Sets projection_type
     *
     * @param string $projection_type projection_type
     *
     * @return $this
     */
    public function setProjectionType($projection_type)
    {
        $this->container['projection_type'] = $projection_type;

        return $this;
    }

    /**
     * Gets projection_message_id
     *
     * @return \IMN\Swagger\Client\Model\MessageId
     */
    public function getProjectionMessageId()
    {
        return $this->container['projection_message_id'];
    }

    /**
     * Sets projection_message_id
     *
     * @param \IMN\Swagger\Client\Model\MessageId $projection_message_id projection_message_id
     *
     * @return $this
     */
    public function setProjectionMessageId($projection_message_id)
    {
        $this->container['projection_message_id'] = $projection_message_id;

        return $this;
    }

    /**
     * Gets current_message_id
     *
     * @return \IMN\Swagger\Client\Model\MessageId
     */
    public function getCurrentMessageId()
    {
        return $this->container['current_message_id'];
    }

    /**
     * Sets current_message_id
     *
     * @param \IMN\Swagger\Client\Model\MessageId $current_message_id current_message_id
     *
     * @return $this
     */
    public function setCurrentMessageId($current_message_id)
    {
        $this->container['current_message_id'] = $current_message_id;
