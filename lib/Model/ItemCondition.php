...
class ItemCondition
{
    ...
    const REFURBISHED_CONDITION = 'RefurbishedCondition';
    const USED_AS_NEW_CONDITION = 'UsedAsNewCondition';
    const USED_VERY_GOOD_CONDITION = 'UsedVeryGoodCondition';
    const USED_GOOD_CONDITION = 'UsedGoodCondition';
    const USED_ACCEPTABLE_CONDITION = 'UsedAcceptableCondition';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            ...
            self::USED_AS_NEW_CONDITION,
            self::USED_VERY_GOOD_CONDITION,
            self::USED_GOOD_CONDITION,
            self::USED_ACCEPTABLE_CONDITION,
        ];
    }
}
