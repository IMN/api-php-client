...
/**
 * OrderDateSearchType Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderDateSearchType
{
    /**
     * Possible values of this enum
     */
    const IMN_MODIFICATION = 'IMNModification';
    const PURCHASE = 'Purchase';
    const MARKETPLACE_MODIFICATION = 'MarketplaceModification';
    ...
    {
        return [
            self::IMN_MODIFICATION,
            self::PURCHASE,
            self::MARKETPLACE_MODIFICATION,
        ];
    }
}
