...
/**
 * MarketplaceCodeTest Class Doc Comment
 *
 * @category    Class */
// * @description The marketplace code identifier in IMN. For now we have: - C1 for Cdiscount - E1 for ePrice - R1 for Real.DE - B1 for BOL - E2 for eMAG
/**
 * @package     IMN\Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MarketplaceCodeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "MarketplaceCode"
     */
    public function testMarketplaceCode()
    {
    }
}
