 ...
 *
 * @category    Class */
// * @description Possible status values of a health check result. * degraded:  The check is degraded, failing but not critical * healthy: The check is healthy * ignored: The check was ignored * unhealthy:  The check is unhealthy
/**
 * @package     IMN\Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class HealthCheckStatusTest extends \PHPUnit_Framework_TestCase
{
