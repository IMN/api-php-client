...
/**
 * OperationSourceTypeTest Class Doc Comment
 *
 * @category    Class */
// * @description Indicates the origin of the operation: * api: the operation has been done using our api directly. * ui: the operation has been done using our user interface.
/**
 * @package     IMN\Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OperationSourceTypeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "OperationSourceType"
     */
    public function testOperationSourceType()
    {
    }
}
