...
/**
 * ParameterInTest Class Doc Comment
 *
 * @category    Class */
// * @description * path: if the parameter must be pass in the path uri * header: if the parameter must be passed in http header * query: if the parameter must be passed in querystring * body: if the parameter must be passed in the body * file: if the parameter must be passed in a multipart/form-data (https://swagger.io/docs/specification/2-0/file-upload/)
/**
 * @package     IMN\Swagger\Client
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ParameterInTest extends \PHPUnit_Framework_TestCase
{
     ...
     * Test "ParameterIn"
     */
    public function testParameterIn()
    {
    }
}
